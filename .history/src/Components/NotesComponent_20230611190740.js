...
const NotesComponent = ({ groupIndex, groupName }) => {
  ...
  return (
    <div className="notes-container">
      <div style={{textAlign:'left', width:'inherit', height:'3rem', display:'flex', alignItems:'center', backgroundColor:'#E8E8E8'}}>
        <div style={{height:'3.5rem', width:'3.5rem', borderRadius:'50%', marginRight:'2rem' , backgroundColor:'blue'}}></div>
        <h2 >{groupName}</h2>
      </div>
