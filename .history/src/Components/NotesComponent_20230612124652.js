...
const NotesComponent = ({ groupIndex, groupName }) => {
  ...
  return (
    <div className="notes-container">
      ...
      <div style={{boxShadow:'0 0 0 2.1rem #E8E8E8', height:'11rem', width:'65vw', backgroundColor:'#fff', display:'flex', flexDirection:'column', borderRadius:'0.5rem'}}>
        ...
        <div style={{width:'100%', display:'flex', justifyContent:"flex-end"}}>
          <img onClick={handleAddNote} src={img2} alt="" style={{marginRight:'2rem', zIndex:2}} height={20} width={20} />
        </div>
