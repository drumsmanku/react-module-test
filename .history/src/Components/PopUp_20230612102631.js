          ...
          <div style={{height:'30vh',paddingLeft:'2rem' }} className="modal">
            ...
            <div style={{marginLeft:'1rem'}}>
              <div>
                ...
                <input style={{width:'25rem',height:'2rem', borderRadius:'2rem', border:'0.2rem solid #CCCCCC', fontSize:'1.5rem'}} type="text" onChange={handleInputChange} value={input} placeholder="Enter your group name...." />
              </div>
