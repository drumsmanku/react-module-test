        ...
        {(close) => (
          <div style={{height:'30vh',paddingLeft:'2rem', paddingTop:'2rem' }} className="modal">
            ...
            <div style={{marginLeft:'1rem'}}>
              ...
              <div style={{display:'flex', alignItems:'center', marginBottom:'2.5rem'}} className="hues">
              ...
              <div style={{width:'90%', display:'flex', justifyContent:'flex-end'}}>
                <button style={{width:'8rem', height:'2rem', backgroundColor:'black', color:'white', border:'none', borderRadius:'0.5rem'}} onClick={handleButtonClick}>add</button>
              </div>
