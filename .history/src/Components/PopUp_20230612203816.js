      ...
      >
        {(close) => (
          <div style={{height:'30vh',paddingLeft:'2rem', paddingTop:'2rem' }} className="modal">
            <div style={{ fontWeight:'bold', fontSize:'1.5rem', marginBottom:'1.5rem'}} className="content">Create New Notes group</div>
            <div style={{marginLeft:'1rem'}}>
              ...
              <div style={{width:'90%', display:'flex', justifyContent:'flex-end'}}>
                <button style={{width:'8rem', height:'2rem', backgroundColor:'black', color:'white', border:'none', borderRadius:'0.5rem', fontSize:'1.2rem', letterSpacing:'0.1rem'}} onClick={handleButtonClick}>add</button>
              </div>
